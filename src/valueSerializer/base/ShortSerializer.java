	...
	public void objectToBuffer(Object anOutputBuffer, Object anObject, ArrayList<Object> visitedObjects)
		...
		if (anObject instanceof Short) {
			...
			if (ByteBuffer.class.isAssignableFrom(bufferClass)) {
				...
				String str = Short.class.getName() + value + ValueSerializer.DELIMETER;
				sBuff.append(str);
			} else {
			...
			throw new NotSerializableException("Tried to serialize a non Short type with the Short value serializer");
		}
	}
